...
type ContactService interface {
	...
	ListPaginated(ctx context.Context, filters repo.ContactFilters, page, pageSize int) (*sqlutils.PaginatedResult[entity.Contact], error)
...
func (s *contactService) GetByID(ctx context.Context, id uuid.UUID, organizationID uuid.UUID) (*entity.Contact, error) {
	contact, err := s.repo.GetByID(ctx, id, organizationID)
	if err != nil {
...
func (s *contactService) GetByEmail(ctx context.Context, email string, organizationID uuid.UUID) (*entity.Contact, error) {
	contact, err := s.repo.GetByEmail(ctx, email, organizationID)
	if err != nil {
...
func (s *contactService) Delete(ctx context.Context, id uuid.UUID) error {
	...
	s.logger.Info("contact deleted successfully", "id", id)
	return nil
}
...
func (s *contactService) ListPaginated(ctx context.Context, filters repo.ContactFilters, page, pageSize int) (*sqlutils.PaginatedResult[entity.Contact], error) {
	...
	s.logger.Debug("contacts listed successfully", "page", result.Page, "total", result.Total)
	return result, nil
}
